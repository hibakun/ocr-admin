...
import 'package:ocr_admin/storage/storage_repository_edukasi.dart';
...
class _KeuanganPageState extends State<KeuanganPage> {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference _collection = _firestore.collection("keuangan");
  ...
  Future<void> imagePicker(String input, String title, String desc) async {
    ...
    if (pickedImage != null) {
      ...
      StorageRespositoryEdukasi()
          .uploadImage("keuangan", "keuangan", pickedImage, title, desc);
    }
  }
}
